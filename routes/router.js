...
router.get('/schedule/weekly',middleware.auth, ScheduleController.get.weekly); // 주간 스케줄 조회
router.get('/schedule/monthly',middleware.auth, ScheduleController.get.montly)  /// 월간 일정 조회
