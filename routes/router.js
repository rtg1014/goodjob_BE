...
router.patch('/auth/lostPassword', AuthController.update.lostPassword); // 인증 메일 발송(비밀번호 분실)
router.patch('/auth/verifyNumberForOld', AuthController.create.verifyNumberForOld); // 인증 번호 확인(비밀번호 분실)
